        ...
        <div className="hidden lg:flex flex-col gap-4 flex-1 max-w-sm">
          <div className="flex items-center gap-3">
            <img
              src="/pwa-512x512.png"
              alt="CSB Logo"
              style={{ width: 56, height: 56, borderRadius: 16, objectFit: 'cover', boxShadow: '0 4px 16px rgba(13,115,119,0.25)' }}
            />
            <span style={{ fontFamily: '"Bricolage Grotesque", system-ui', fontWeight: 800, fontSize: 28, letterSpacing: '-0.5px', color: '#1c1e21' }}>
              CSB Updates
            </span>
          </div>
        ...
        <div className="w-full max-w-[396px]">
          ...
          <div className="lg:hidden flex flex-col items-center gap-3 mb-8">
            <img
              src="/pwa-512x512.png"
              alt="CSB Logo"
              style={{ width: 80, height: 80, borderRadius: 22, objectFit: 'cover', boxShadow: '0 6px 24px rgba(13,115,119,0.2)' }}
            />
          ...
          <div className="bg-white rounded-2xl px-6 py-8 shadow-sm border border-[#DADDE1]">
              ...
              {['login', 'register'].map(m => (
                <button
                  ...
                  style={{
                    ...
                    fontSize: 14, fontWeight: 600, fontFamily: '"Instrument Sans", system-ui',
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <button
                ...
                style={{
                  marginTop: 4, width: '100%', padding: '14px 0', borderRadius: 12, border: 'none',
                  background: loading ? '#7EC8C8' : '#0D7377', color: 'white',
          ...
          <p style={{ textAlign: 'center', fontSize: 12, color: '#65676B', marginTop: 20, fontFamily: '"Instrument Sans", system-ui' }}>
            CSB Updates · Student Announcement Platform
          </p>
        </div>
      </div>
